...
function Board() {
  ...
  function handleKeyDown9(e) {
    ...
    const indexOfEmptyTile = currentArrangementOfNrs.find(
      (n) => n.value === nrOfTiles,
    ).index;
    ...
    if (e.keyCode === 37 && indexOfEmptyTile % 3 !== 2)
      ...
      moveTile(
        currentArrangementOfNrs.find((n) => n.index === indexOfEmptyTile + 1),
      );
    ...
    if (e.keyCode === 38 && !(indexOfEmptyTile > 5))
      ...
      moveTile(
        currentArrangementOfNrs.find((n) => n.index === indexOfEmptyTile + 3),
      );
  ...
  function handleKeyDown16(e) {
    ...
    if (e.keyCode === 37 && !(indexOfLastTile % 4 === 3))
      ...
      moveTile(
        currentArrangementOfNrs.find((n) => n.index === indexOfLastTile + 1),
      );
    ...
    if (e.keyCode === 38 && !(indexOfLastTile > 11))
      ...
      moveTile(
        currentArrangementOfNrs.find((n) => n.index === indexOfLastTile + 4),
      );
  ...
  function handleKeyDown25(e) {
    ...
    if (e.keyCode === 38 && !(indexOfEmptyTile > 19))
      // Move the tile adjacent to the empty tile upwards
      moveTile(
        currentArrangementOfNrs.find((n) => n.index === indexOfEmptyTile + 5),
      );
