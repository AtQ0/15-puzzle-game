    ...
    <div className={styles["instructions-container"]}>
      ...
      <div className={styles["btn-wrapper"]}>
        <button
          ...
          onClick={handleRenderingOfInstructions}
        >
          PLAY
        </button>
      </div>
...
Instructions.propTypes = {
  handleRenderingOfInstructions: PropTypes.func.isRequired,
};
